...
<details>
  ...
  <ol>
    ...
    <li>Navigate to the <strong>Actions tab</strong> in your forked repository and select <strong>Build YTLitePlusEXTRA IPA. ( Make sure you choose For Sideloading or Not For Sideloading workflow for your target device and DON'T USE FOR TESTING ONE )</strong></li>
